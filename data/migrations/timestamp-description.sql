...
this query will create a second table in lab14_normal database named authors 
...
his query will add a column to the books table named author_id.his will connect each book to a specific author in the other table.
